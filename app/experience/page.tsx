    ...
    <section>
      ...
      <div className="space-y-12">
        <div>
          ...
          <ul className="max-w-[600px] text-neutral-800 dark:text-neutral-200 list-disc list-inside space-y-2">
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-2">Machine Learning Internship</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Productiv | Bellevue, Washington | June. 2022 - Aug. 2022</p>
          <ul className="max-w-[600px] text-neutral-800 dark:text-neutral-200 list-disc list-inside space-y-2">
            <li>Parsing layout from scanned document and populated desired fields into digital forms by finetuning layoutLM transformer based models.</li>
            <li>Designed a simple internal UI for data collection and analysis.</li>
          </ul>
        </div>
        <div>
