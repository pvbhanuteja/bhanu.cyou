---
title: 'Deep Learning Docker Image with GPU Support and Quick SSH using Cloudflared'
publishedAt: '2023-05-02'
summary: 'Deep learning Docker image with GPU support and how to quickly SSH into the server using Cloudflared if the server is not publicly accessible uses github gist as config file'
---
You can find the GitHub repo [here](https://github.com/pvbhanuteja/gs-dl-baseimage-cloudflared).
...
![Gradient Space Notebook](https://cdn-images-1.medium.com/max/3372/0*OshQoxu9IdGTmm7z.png)
...
![Create a new tunnel](https://cdn-images-1.medium.com/max/2828/0*TYKZY1A8g2H4-OdG.png)

3. Copy the tunnel token to use it in your config.

![Copy tunnel token](https://cdn-images-1.medium.com/max/4000/0*U_OnOmg1Yc0OsdMw.png)
...
![Configure tunnel](https://github.com/pvbhanuteja/gs-dl-baseimage-cloudflared/raw/main/images/configure_tunnel.png)
