  ...
  return (
      ...
      >
        <g clipPath="url(#clip0)">
          <path
              d="M12 12.713L22.018 4.51C22.55 4.14 24 .666 24 .666V20.334C24 21.405 23.105 22.3 22.018 22.3H1.982C.895 22.3 0 21.405 0 20.334V.666S1.45 4.14 1.982 4.51L12 12.713z"
              fill="currentColor"
          />
          <path
              d="M.528 1.35C.528 1.35 2.973 3.82 4.356 5.2L12 12.715L19.645 5.2C21.027 3.82 23.472 1.35 23.472 1.35C23.472 1.35 24 1.886 24 2.703V3.95L12 14.26L0 3.95V2.703C0 1.886.528 1.35.528 1.35z"
              fill="currentColor"
          />
        </g>
        <defs>
